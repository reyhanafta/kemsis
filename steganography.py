...
global image1
image1=ImageTk.PhotoImage(Image.open("bg1.png"))
label=Label(main,text="lalal",image=image1)
label.pack()

encbutton=Button(text='Encode',fg="white",bg="blue",width=20,command=encode)
encbutton['font'] =fontl 
encbutton.place(relx=0.6,rely=0.3)


decbutton=Button(text='Decode',fg="white",bg="green",width=20,command=decode)
